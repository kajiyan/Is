...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, _) {(function(window, document, $) {
	  ...
	  try {
	    ...
	    bg = {};
	    bg.appRun = function() {
	      return console.log("%c[index] APP RUN", "color: #d9597b");
	    };
	    bg.appStop = function() {
	      return console.log("%c[index] APP STOP", "color: #d9597b");
	    };
	    window.bg = bg;
	  }
	      ...
	      return $.when((function() {
	        ...
	        return function() {
	          ...
	          return $.when((function() {
	            ...
	            for (key in ref) {
	              view = ref[key];
	              results.push(typeof view.setup === "function" ? view.setup() : void 0);
	            }
	            return results;
	          })());
	        };
	        ...
	        return function() {
	          return $.when(console.log("%cPopup Setup Complete", "color: #d9597b"));
	        };
	      })(this));
	    });
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Stage = (function(superClass) {
	    ...
	    Stage.prototype.initialize = function() {
	      return console.log("%c[View] Stage -> initialize", "color: #d9597b");
	    };
	    ...
	    Stage.prototype._checkInManualRoomHandler = function(e) {
	      e.preventDefault();
	      console.log("%c[View] Stage -> _checkInManualRoomHandler", "color: #d9597b");
	      return window.bg.appRun();
	    };
	
	    Stage.prototype._checkInAutomaticRoomHandler = function(e) {
	      e.preventDefault();
	      console.log("%c[View] Stage -> _checkInAutomaticRoomHandler", "color: #d9597b");
	      return window.bg.appRun();
	    };
	
	    Stage.prototype._checkOutHandler = function(e) {
	      e.preventDefault();
