...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, Backbone, _) {(function(window, document, $) {
	  ...
	  jQBridget = __webpack_require__(5);
	  ...
	  sn.bb.models = {
	    stage: (function() {
	      var Stage;
	      Stage = __webpack_require__(4)(sn, $, _);
	      return new Stage();
	    })(),
	    connect: (function() {
	      var Connect;
	      Connect = __webpack_require__(8)(sn, $, _);
	      return new Connect();
	    })()
	  };
	  sn.bb.views = {
	    "stage": (function() {
	      var Stage;
	      Stage = __webpack_require__(9)(sn, $, _);
	      return new Stage({
	  ...
	  return $(function() {
	    sn.tf.setup(function() {
	      ...
	      return $.when((function() {
	        ...
	        return function() {
	          return $.when(sn.bb.views.stage.setup());
	        };
	      })(this)).then((function(_this) {
	        return function() {
	          return console.log("- SETUP CONTENT SCRIPT -");
	        };
	      })(this));
	    });
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Connect = (function(superClass) {
	    ...
	    Connect.prototype.initialize = function() {
	      ...
	      return this.listenTo(this, "change:isRun", this._changeIsRunHandler);
	    };
	    ...
	    Connect.prototype._changeIsRunHandler = function(model, isRun) {
	      console.log("%c[Model] Connect -> _changeIsRunHandler", "color: #619db9", isRun);
	      if (!isRun) {
	        console.log("call");
	        return this.stopListening(sn.bb.models.stage, "change:pointerPosition");
	      }
	    };
	
	    Connect.prototype._setBackgroundPort = function(port) {
	      console.log("%c[Model] Connect -> _setBackgroundPort", "color: #619db9", port);
	      port.postMessage({
	        to: "background",
	        from: "contentScript"
	      });
	      return this.listenTo(sn.bb.models.stage, "change:pointerPosition", this._changePointerPositionHandler(port));
	    };
	
	    Connect.prototype._changePointerPositionHandler = function(port) {
	      return function(stageModel, pointerPosition) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, _) {
	  ...
	  return Stage = (function(superClass) {
	    ...
	    Stage.prototype._pointerMoveHandler = function(e) {
	      return this.model.set("pointerPosition", {
	        "x": e.clientX,
	        "y": e.clientY
	      });
	    };
