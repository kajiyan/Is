...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, Backbone, _) {(function(window, document, $) {
	  ...
	  jQBridget = __webpack_require__(7);
	  ...
	  sn.modules = {
	    stage: __webpack_require__(11)(Extension, sn, $, _),
	    connect: __webpack_require__(12)(Extension, sn, $, _),
	    memory: __webpack_require__(13)(Extension, sn, $, _)
	  };
	  return $(function() {
	    sn.tf.setup(function() {
	      ...
	      return Extension.module("ExtensionModule", function(ExtensionModule, Extension, Backbone, Marionette, $, _) {
	        var ExtensionLayoutView, LoverItemView, LoverModel, LoversCollection, LoversCollectionView, MemoryItemView, MemoryModel, MemorysCollection, MemorysCollectionView, extensionRegion, isEl, isElShadowRoot, isTemplate, isTemplateCloneNode;
	        ...
	        LoversCollection = Backbone.Collection.extend({
	          initialize: function() {
	            ...
	            Extension.vent.on("connectUpdateLocation", this._updateLocationHandler.bind(this));
	        ...
	        MemorysCollection = Backbone.Collection.extend({
	          initialize: function() {
	            return console.log("%c[Extension] LoversCollection -> memorysCollection", debug.style);
	          },
	          model: MemoryModel
	        });
	        ...
	        MemoryItemView = Backbone.Marionette.ItemView.extend({
	          ...
	          events: {
	            "click @ui.body": function() {
	              return console.log("%c[ExtensionModule] MemoryItemView -> click", debug.style);
	            }
	          },
	          _update: function(process) {
	            ...
	            this._updateProcess = window.requestAnimationFrame((function(_this) {
	              return function() {
	            ...
	            return this._oldFrame = this._currentFrame;
	          },
	          onBeforeRender: function() {
	            return console.log("%c[ExtensionModule] MemoryItemView -> onBeforeRender", debug.style);
	          },
	          onDestroy: function() {
	            return console.log("%c[ExtensionModule] MemoryItemView -> onDestroy", debug.style);
	          }
	        });
	        LoversCollectionView = Backbone.Marionette.CollectionView.extend({
	          initialize: function() {
	            return console.log("[ExtensionModule] LoversCollectionView -> initialize");
	          },
	          tagName: "div",
	          className: "lovers",
	        ...
	        MemorysCollectionView = Backbone.Marionette.CollectionView.extend({
	          initialize: function() {
	            return console.log("[ExtensionModule] MemorysCollectionView -> initialize");
	          },
	          tagName: "div",
	          className: "memorys",
	          ...
	          childEvents: {
	            onDestroy: function() {
	              return console.log("%c[ExtensionModule] MemorysCollectionView -> onDestroy", debug.style);
	            }
	          }
	        });
	        ...
	        ExtensionModule.addInitializer(function() {
	          var loversCollection, loversCollectionView, memorysCollection, memorysCollectionView;
	          ...
	          return Extension.content.currentView.memorys.show(memorysCollectionView);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {/* VelocityJS.org UI Pack (5.0.4). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License. Portions copyright Daniel Eden, Christian Pucci. */
	    ...
	    StageModule.addInitializer(function(options) {
	      ...
	      return this.views = {
	        stage: new StageItemView({
	          model: this.models.stage
	        })
	      };
	    });
	    return StageModule.addFinalizer(function() {
	      return console.log("%c[Stage] addFinalizer", debug.style);
	    });
	  });
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _) {
	  ...
	  return App.module("ConnectModule", function(ConnectModule, App, Backbone, Marionette, $, _) {
	    var ConnectModel;
	    ...
	    ConnectModel = Backbone.Model.extend({
	            ...
	            if (((message.from != null) && message.from === "background") && (message.type != null)) {
	              switch (message.type) {
	                ...
	                case "updateLocation":
	                  ...
	                  return App.vent.trigger("connectUpdateLocation", message.body);
	      ...
	      _addMemoryHandler: function(port) {
	        return function(data) {
	    ...
	    ConnectModule.addInitializer(function(options) {
	      ...
	      return App.commands.setHandler("connectUpdateLandscape", function() {
	        return console.log("%c[Connect] Commands |connectUpdateLandscape", debug.style);
	      });
	    });
	    return ConnectModule.addFinalizer(function() {
	      return console.log("%c[Connect] addFinalizer", debug.style);
	    });
	  });
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _) {
	  ...
	  return App.module("MemoryModule", function(MemoryModule, App, Backbone, Marionette, $, _) {
	    var MemoryItemView, MemoryModel, MemorysCollection;
	    ...
	    MemorysCollection = Backbone.Collection.extend({
	      initialize: function() {
	        return console.log("%c[Memory] MemorysCollection -> initialize", debug.style);
	      },
	      model: MemoryModel
	    });
	    MemoryItemView = Backbone.Marionette.ItemView.extend({
	      ...
	      events: {
	        "click @ui.body": function() {
	          return console.log("%c[Memory] MemoryItemView -> click", debug.style);
	        }
	      },
	      _update: function(process) {
	        if (process == null) {
	      ...
	      onBeforeRender: function() {
	        return console.log("%c[Memory] MemoryItemView -> onBeforeRender", debug.style);
	      },
	      onDestroy: function() {
	        return console.log("%c[Memory] MemoryItemView -> onDestroy", debug.style);
	      }
	    });
	    MemoryModule.addInitializer(function(options) {
	      return console.log("%c[Memory] addInitializer", debug.style, options);
	    });
	    return MemoryModule.addFinalizer(function() {
	      return console.log("%c[Memory] addFinalizer", debug.style);
	    });
	  });
	};
