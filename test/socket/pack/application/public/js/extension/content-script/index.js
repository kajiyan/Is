...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, Backbone, _) {(function(window, document, $) {
	  ...
	  jQBridget = __webpack_require__(6);
	  ...
	  return $(function() {
	    sn.tf.setup(function() {
	      var AppLayoutView, appRegion, debug, isEl, isElShadowRoot, isTemplate, isTemplateCloneNode;
	      debug = {
	      ...
	      sn.modules = {
	        stage: __webpack_require__(11)(App, sn, $, _),
	        connect: __webpack_require__(12)(App, sn, $, _),
	        lover: __webpack_require__(13)(App, sn, $, _, isElShadowRoot),
	        memory: __webpack_require__(14)(App, sn, $, _, isElShadowRoot)
	      };
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _, isElShadowRoot) {
	  var debug;
	  debug = {
	    style: "background-color: DarkBlue; color: #ffffff;"
	  };
	  return App.module("LoverModule", function(LoverModule, App, Backbone, Marionette, $, _) {
	    var LoverItemView, LoverModel, LoversCollection, LoversCollectionView;
	    ...
	    LoverModel = Backbone.Model.extend({
	      ...
	      initialize: function() {
	        return console.log("%c[Lover] LoverModel -> initialize", debug.style);
	      },
	      _changePositionHandler: function() {
	        return console.log("%c[Lover] LoverModel -> _changePositionHandler", debug.style);
	      }
	    });
	    LoversCollection = Backbone.Collection.extend({
	      initialize: function() {
	        ...
	        return App.vent.on("connectUpdateLandscape", this._updateLandscapeHandler.bind(this));
	      },
	      model: LoverModel,
	    ...
	    LoversCollectionView = Backbone.Marionette.CollectionView.extend({
	      initialize: function() {
	        return console.log("%c[Lover] LoversCollectionView -> initialize", debug.style);
	      },
	      tagName: "div",
	      className: "lovers",
	    ...
	    LoverModule.addInitializer(function(options) {
	      ...
	      return App.content.currentView.lovers.show(loversCollectionView);
	    });
	    return LoverModule.addFinalizer(function() {
	      return console.log("%c[Lover] addFinalizer", debug.style);
	    });
	  });
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _, isElShadowRoot) {
	  ...
	  return App.module("MemoryModule", function(MemoryModule, App, Backbone, Marionette, $, _) {
	    var MemoryItemView, MemoryModel, MemorysCollection, MemorysCollectionView;
	    ...
	    MemorysCollectionView = Backbone.Marionette.CollectionView.extend({
	      initialize: function() {
	        return console.log("%c[Memory] MemorysCollectionView -> initialize", debug.style);
	      },
	      tagName: "div",
	      className: "memorys",
	      ...
	      childEvents: {
	        onDestroy: function() {
	          return console.log("%c[Memory] MemorysCollectionView -> onDestroy", debug.style);
	        }
	      }
	    });
	    MemoryModule.addInitializer(function(options) {
	      ...
	      return App.content.currentView.memorys.show(memorysCollectionView);
	    });
