...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, Backbone, _) {(function(window, document, $) {
	  ...
	  sn.modules = {
	    stage: __webpack_require__(7)(Background, sn, $, _),
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _) {
	  ...
	  return App.module("StageModule", function(StageModule, App, Backbone, Marionette, $, _) {
	    ...
	    return StageModule.addFinalizer(function(options) {
	      return console.log("%c[Stage] addFinalizer", debug.style, options);
	    });
	  });
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _) {
	  ...
	  return App.module("ConnectModule", function(ConnectModule, App, Backbone, Marionette, $, _) {
	    ...
	    return ConnectModule.addFinalizer(function(options) {
	      return console.log("%c[Connect] addFinalizer", debug.style, options);
	    });
	  });
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(App, sn, $, _) {
	  ...
	  return App.module("SocketModule", function(SocketModule, App, Backbone, Marionette, $, _) {
	    var SocketModel;
	    ...
	    SocketModel = Backbone.Model.extend({
	      ...
	      _reconnectAttemptHandler: function() {
	        return console.log("%c[Socket] SocketModel -> _reconnectAttemptHandler", debug.style);
	      },
	      _reconnectingHandler: function(reconnection) {
	        return console.log("%c[Socket] SocketModel -> _reconnectingHandler", debug.style, reconnection);
	      },
	      _reconnectErrorHandler: function(error) {
